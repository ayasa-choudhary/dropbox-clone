...
const IntroSection = ({ scrollYProgress }) => {
  const opacity = useTransform(scrollYProgress, [0, 0.03, 0.08], [1, 1, 0]);
  const scale = useTransform(scrollYProgress, [0, 0.03, 0.08], [1, 1, 0.95]);
    ...
    >
      ...
      <motion.div
        ...
        style={{ 
          width: logoSize,
          height: logoSize,
          bottom: useTransform(scrollYProgress, [0.05, 0.15, 0.25, 0.45], ["auto", "16px", "16px", "auto"]),
          right: useTransform(scrollYProgress, [0.05, 0.15, 0.25, 0.45], ["auto", "16px", "16px", "auto"]),
          opacity: useTransform(scrollYProgress, [0.05, 0.1, 0.2, 0.3, 0.45], [1, 0.7, 0.7, 0.9, 1])
        }}
        transition={{ duration: 0.2, ease: "easeInOut" }}
      >
...
export default function AnimatedGrid() {
  ...
  const tilesOpacity = useTransform(scrollYProgress, [0.3, 0.6], [0, 1]);
  const tilesScale = useTransform(scrollYProgress, [0.3, 0.6], [0.9, 1]);
  ...
  return (
    <div 
      ...
      className="h-[101vh] w-full relative overflow-y-auto overflow-x-hidden"
    >
      <motion.div 
